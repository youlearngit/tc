...
<a href="<?=$mymps_global['SiteUrl']?>/m/index.php?mod=category" class="bottom_category<? echo $mod == 'category' ? '_on' : '';; ?>">分类</a>
<a href="<?=$mymps_global['SiteUrl']?>/m/index.php?mod=post" class="bottom_post<? echo $mod == 'post' ? '_on' : '';; ?>">发布</a>
<a href="<?=$mymps_global['SiteUrl']?>/m/index.php?mod=news" class="bottom_news<? echo $mod == 'news' ? '_on' : '';; ?>">资讯</a>
